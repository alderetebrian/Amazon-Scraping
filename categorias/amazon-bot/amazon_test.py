...
class AmazonAPI:
    ...
    def run(self):
        ...
        #time.sleep(14)
        #sub_categorias_2 = self.verificar_sub_categoria_2(json)
        self.driver.quit()
    ...
    def json_base(self):
        ...
        self.makeJson('json_level_1',sub_categorias_2)
    '''
    def run(self):
        self.driver.get(URL_TESTING)
        soup = self.soup_file()
    ...
    def verificar_sub_categoria_2(self, categorias):
        ...
        for categoria in categorias:
            for link in categoria['sub_categoria']:
                verificar = self.verificar_sub_categoria_2_simple(link['link'])
